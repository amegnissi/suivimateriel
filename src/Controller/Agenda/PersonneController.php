...
{
    #[Route(name: 'admin_personne_index', methods: ['GET'])]
    public function index(PersonneRepository $personneRepository): Response
    {
        return $this->render('agenda/personne/index.html.twig', [
            'personnes' => $personneRepository->findAll(),
        ]);
    }

    #[Route('/new', name: 'admin_personne_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'Le contact a ete enregistrée avec succès.');
            return $this->redirectToRoute('admin_personne_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('agenda/personne/new.html.twig', [
            'personne' => $personne,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('agenda/personne/show.html.twig', [
            'personne' => $personne,
        ]);
    }
    ...
    public function edit(Request $request, Personne $personne, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('agenda/personne/edit.html.twig', [
            'personne' => $personne,
            'form' => $form,
        ]);
    }
