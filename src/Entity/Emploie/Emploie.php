...
#[ORM\Entity(repositoryClass: EmploieRepository::class)]
class Emploie
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: OperationEmploie::class, mappedBy: 'designation')]
    ...
    public function addOperationEmploie(OperationEmploie $operationEmploie): static
    {
        if (!$this->operationEmploies->contains($operationEmploie)) {
            ...
            $operationEmploie->setDesignation($this);
        }
    ...
    public function removeOperationEmploie(OperationEmploie $operationEmploie): static
    {
        if ($this->operationEmploies->removeElement($operationEmploie)) {
            ...
            if ($operationEmploie->getDesignation() === $this) {
                $operationEmploie->setDesignation(null);
            }
        }
